export const posts = [
    ...
    },
    {
        ...
        downloadUrl:
            "https://drive.google.com/uc?export=download&id=1wR2antCZrPjAIXN7qQRnkk3WXd6-8QUF",
        releaseDate: "Aug 23, 2024",
        subtitledBy: "ඕෂද එරංග (Era Boy): (Cineru.LK)",
        subtitleSite: "Cineru.LK",
        director: "Shaji Kailas",
        producer: "K. Radhakrishnan",
        cast: "Bhavana, Renji Panicker, Chandhunadh, Dain Davis, Ajmal Ameer, Aditi Ravi",
    ...
    },
    {
        ...
        content:
            ...
            "\n" +
            "පස්සේ ජෝසේට ඇතිවන ප්‍රශ්නත් එක්ක එයාට චෙන්නායි වල රැකියාවක් හොයාදෙන්නෙත් ඉන්දු. (හේතුව මොකක්ද කියලා ෆිල්ම් එක බලලම දැනගන්නකෝ.) ඒ හින්දම එයාම එයාගේ පවුලට වෙච්ච දේවල් නැවත සමථයකට පත් කරලා ඉන්දුගේ පවුලත් නැවත එකතු කරන්නත් ජෝසේ කටයුතු කරනවා.\n" +
            "\n" +
    ...
    },
    {
        ...
        subtitledBy: "ඕෂද එරංග (Era Boy): (SinhalaSub.LK)",
    ...
    },
    {
        ...
        subtitledBy: "BANDULA K (Baiscope.lk)",
